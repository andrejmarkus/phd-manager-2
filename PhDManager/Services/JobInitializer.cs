...
namespace PhDManager.Services
{
    public class JobInitializer(UsersService usersService, AppStateService appStateService)
    {
        public void Initialize()
        {
            ...
            RecurringJob.AddOrUpdate("openSystem", () => appStateService.SetSystemOpenAsync(true), "0 0 1 12 *");
            RecurringJob.AddOrUpdate("closeSystem", () => appStateService.SetSystemOpenAsync(false), "0 0 15 2 *");
        }
    }
}
